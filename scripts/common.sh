...
then
	mx2cc="../bin/mx2cc_pi"
	mx2cc_new="../src/mx2cc/mx2cc.buildv1.0.2/desktop_release_pi/mx2cc"
	
	ted2="../bin/ted2_pi"
	ted2_new="../src/ted2/ted2.buildv1.0.2/desktop_release_pi"
	
	launcher="../Monkey2 (Pi)"
	launcher_new="../src/launcher/launcher.buildv1.0.2/desktop_release_pi/launcher"
